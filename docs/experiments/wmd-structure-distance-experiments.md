...
- **The other gates** - scramble-monotonicity holds for both (Spearman 1.00, top-rising, both articles); translation-invariance separates them (pure shift: H44 0.42 of range, H55 0.001 - index-intrinsic); the metric check is H44's only win (triangle violations 0% vs H55's 4.5%, the KL prior)
